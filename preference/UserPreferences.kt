...
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.AppTheme
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.browser.ProxyChoice
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.browser.SearchBoxDisplayChoice
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.browser.SearchBoxModel
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.constant.DEFAULT_ENCODING
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.constant.SCHEME_HOMEPAGE
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.device.ScreenSize
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.di.UserPrefs
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.preference.delegates.*
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.search.SearchEngineProvider
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.search.engine.GoogleSearch
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.utils.FileUtils
import all.video.allvideodownloader.freevideodownloader.hddownloaderapp.view.RenderingMode
...
class UserPreferences @Inject constructor(
     ...
     * True if the browser should allow websites to open new windows, false otherwise.
     */
    var saveToGallery by preferences.booleanPreference(SAVE_GALLERY, true)

    /**
     * The folder into which files will be downloaded.
     */
    var language by preferences.stringPreference(LANGUAGE, "system_default")

    /**
     * True if the browser should allow websites to open new windows, false otherwise.
     */
    var instagramDialog by preferences.booleanPreference(INSTAGRAM_DIALOG, false)

    /**
     * True if the browser should allow websites to open new windows, false otherwise.
     */
    var twitterDialog by preferences.booleanPreference(TWITTER_DIALOG, false)
...
private const val SAVE_GALLERY = "save_to_gallery"
private const val LANGUAGE = "language"
private const val INSTAGRAM_DIALOG = "instagram_dialog"
private const val TWITTER_DIALOG = "twitter_dialog"